...
{
    internal class RunItemConfiguration : IEntityTypeConfiguration<RunItem>
    {
        void IEntityTypeConfiguration<RunItem>.Configure(EntityTypeBuilder<RunItem> builder)
        {
            builder.HasKey(e => e.Id);

            builder.Property(e => e.RunIterationId)
    .IsRequired();
    ...
    .HasConversion(id => id.HasValue ? (Guid?)id.Value.Value : (Guid?)null,
            ...
            builder.HasOne(e => e.Iteration)
            .WithMany(e => e.RunItems)
            .HasForeignKey(e => e.RunIterationId);
        }
    }
}
